...
public class SupportedApisApi {
     ...
     */
    public BackgroundOperationResponse getApiList(Integer recursion, String filter) throws ApiException {
        ApiResponse<BackgroundOperationResponse> localVarResp = getApiListWithHttpInfo(recursion, filter);
     ...
     */
    public ApiResponse<BackgroundOperationResponse> getApiListWithHttpInfo(Integer recursion, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call getApiListAsync(Integer recursion, String filter, final ApiCallback<BackgroundOperationResponse> _callback) throws ApiException {
