...
public class CertificateChainGenerationServiceImpl implements CertificateChainGenerationService {
        ...
        public X509CertificateAndKeyPair generateX509Certificate(String issuedTo, String rootCertificateAlias, String issuedCertificateAliase) throws Exception{
            ...
            X500Name issuedCertSubject = new X500Name("CN=" + issuedTo);
            ...
            logger.info("ISSUED CERTIFICATE >>>>>>>>>>>> {}", issuedCert);

            // Verify the issued cert signature against the root (issuer) cert
            issuedCert.verify(rootCert.getPublicKey(), BC_PROVIDER);

            X509CertificateAndKeyPair x509CertificateAndKeyPair = new X509CertificateAndKeyPair();
            x509CertificateAndKeyPair.setKeyPair(issuedCertKeyPair);
            x509CertificateAndKeyPair.setX509Certificate(issuedCert);
