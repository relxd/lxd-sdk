...
| [**getResourcesWithHttpInfo**](ResourcesApi.md#getResourcesWithHttpInfo) | **GET** /1.0/resources |  |



## getResources

> CompletableFuture<BackgroundOperationResponse> getResources(recursion, filter)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<BackgroundOperationResponse> result = apiInstance.getResources(recursion, filter);
...
> CompletableFuture<ApiResponse<BackgroundOperationResponse>> getResources getResourcesWithHttpInfo(recursion, filter)
...
public class Example {
    public static void main(String[] args) {
        ...
        String filter = "filter_example"; // String | There is no default value for filter which means that all results found will be returned. The language follows the OData conventions for structuring REST API filtering logic. Logical operators are also supported for filtering: not(not), equals(eq), not equals(ne), and(and), or(or). Filters are evaluated with left associativity. Values with spaces can be surrounded with quotes. Nesting filtering is also supported.
        try {
            CompletableFuture<ApiResponse<BackgroundOperationResponse>> response = apiInstance.getResourcesWithHttpInfo(recursion, filter);
