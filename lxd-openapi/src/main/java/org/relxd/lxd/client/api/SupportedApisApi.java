...
public class SupportedApisApi {
  ...
  public SupportedApisApi() {
    this(new ApiClient());
  }

  public SupportedApisApi(ApiClient apiClient) {
   ...
   */
  public CompletableFuture<BackgroundOperationResponse> getApiList(Integer recursion, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getApiListRequestBuilder(recursion, filter);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getApiList", localVarResponse));
            }
            try {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<BackgroundOperationResponse>> getApiListWithHttpInfo(Integer recursion, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getApiListRequestBuilder(recursion, filter);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder getApiListRequestBuilder(Integer recursion, String filter) throws ApiException {
