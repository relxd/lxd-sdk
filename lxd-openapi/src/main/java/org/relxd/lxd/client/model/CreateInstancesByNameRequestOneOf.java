 ...
 */
@JsonPropertyOrder({
  CreateInstancesByNameRequestOneOf.JSON_PROPERTY_NAME,
  CreateInstancesByNameRequestOneOf.JSON_PROPERTY_MIGRATION,
  CreateInstancesByNameRequestOneOf.JSON_PROPERTY_LIVE
})
...
public class CreateInstancesByNameRequestOneOf {
  ...
  **/
  ...
  /**
   * Return true if this CreateInstancesByNameRequest_oneOf object is equal to o.
   */
  @Override
