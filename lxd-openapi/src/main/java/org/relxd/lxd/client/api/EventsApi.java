...
public class EventsApi {
   ...
   */
  public CompletableFuture<BackgroundOperationResponse> getEvents(String type, Integer recursion, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getEventsRequestBuilder(type, recursion, filter);
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<BackgroundOperationResponse>> getEventsWithHttpInfo(String type, Integer recursion, String filter) throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getEventsRequestBuilder(type, recursion, filter);
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder getEventsRequestBuilder(String type, Integer recursion, String filter) throws ApiException {
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling getEvents");
    }
